...
-   player_client: Clients to extract video data from. The currently
    ...
    tv_simply and tv_embedded. By default, tv,android_sdkless,web is
    used. If no JavaScript runtime is available, then
    android_sdkless,web_safari,web is used. If logged-in cookies are
    passed to yt-dlp, then tv,web_safari,web is used for free accounts
    and tv,web_creator,web is used for premium accounts. The web_music
